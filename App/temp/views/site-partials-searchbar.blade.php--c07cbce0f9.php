...
';
        ...
        <div class="searchbar_info">
            <a href="#" id="favorite_icon" class="text-red text-xl hidden md:inline">
                <i class="ri-heart-line"></i>
            </a>

            <button id="cart_icon" class="text-black text-5xl md:text-xl">
                <i class="ri-shopping-bag-4-line"></i>
            </button>

            <span id="price_icon" class="font-bold text-green-900 hidden md:inline">$150.00</span>
        </div>
    </div>
</div>
';
